...
if __name__ == "__main__":
    ...
    n_PAS['uber'].append(0)
    n_I['uber'].append(180)
    n_RHI['uber'].append(75)
    n_RH['uber'].append(150)

    n_PAS['lyft'].append(0)
    n_I['lyft'].append(270)
    n_RHI['lyft'].append(75)
    ...
    print("utilisation rate of vehicles:  " + str(
        ((max_t * 900 / delta_t) - (sum(n_I['uber']) + sum(n_I['lyft']))) / (max_t * 900 / delta_t)))
