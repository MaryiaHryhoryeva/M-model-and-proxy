...
Y = {"st_dev_idle": glob_st_dev_idle}
X = {
...
def poly_regression1():
    ...
    #print('mean_sqrd_error is ==', mean_squared_error(y_test, y_prediction))
    #print('root_mean_squared error of is ==', np.sqrt(mean_squared_error(y_test, y_prediction)))
    #print("prediction: " + str(sum(y_prediction)/len(y_prediction)))
    #for i in y_prediction:
    #    print(i)

    #real_data_ = PolynomialFeatures(degree=2, include_bias=False).fit_transform(real_data)
    #sigma_idle = model3.predict(real_data_)
    #return sigma_idle
...
def poly_regression2():
    ...
    filename = '/Users/maryia/PycharmProjects/SimulationTrial/estimation models/st_dev_idle_dist_model'
